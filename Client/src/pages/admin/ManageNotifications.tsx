  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <h1 className="text-3xl font-bold text-gray-900">Send Platform Notification</h1>
        <p className="text-gray-600 mt-1">Broadcast notifications to all platform users</p>
      </div>
